...
<Warning>
For your AI agent to work best with Postiz, load the SKILL md file from [github.com/gitroomhq/postiz-agent](https://github.com/gitroomhq/postiz-agent) or install it from ClawHub at [clawhub.ai/nevo-david/postiz](https://clawhub.ai/nevo-david/postiz).
</Warning>
