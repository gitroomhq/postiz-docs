...
There is no self-serve account deletion or data export in Postiz today. For
account closure or a copy of your data, use the contact details on
[postiz.com](https://postiz.com) rather than Discord, since it involves account
details you should not post publicly.
...
|---|---|
| A product question or something not working | [Discord](https://discord.postiz.com) |
| A bug in the app | [GitHub issues](https://github.com/gitroomhq/postiz-app/issues) |
| A refund | The in-app support chat |
| Anything with account or payment details | The contact details on [postiz.com](https://postiz.com) |
