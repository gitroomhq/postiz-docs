...
The Chrome Extension ID for cookie-based platform integrations (e.g., Skool). Required if you want to use platforms that don't offer OAuth APIs.

See the [Chrome Extension guide](/configuration/chrome-extension) for setup instructions.
