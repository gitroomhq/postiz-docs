...
This page explains [How to setup your development environment](/self-host/installation/development).

## Architecture Overview

Before getting started with development, have a good read of the [architecture overview](/self-host/architecture). This will give you a good understanding of how the project is structured and how the different parts of the project interact with each other.
