...
[Connect failures on self-hosted installs](/self-host/troubleshooting#connect-failures).
</Note>
...
<Card title="Self-hosting?" icon="server" href="/self-host/troubleshooting#connect-failures">
