...
An example file of the most used configuration settings can be found here; [example Publica.env file](https://raw.githubusercontent.com/gitroomhq/Publica-app/main/.env.example)
