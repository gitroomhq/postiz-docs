...
Publica is an open-source project, and the source code is available on [GitHub](https://github.com/gitroomhq/Publica-app).
...
The Publica [contributors guide](https://github.com/gitroomhq/Publica-app/blob/main/CONTRIBUTING.md) is contained in the main repository. It provides information on how to contribute to the project, mainly the format for how to submit a pull request.
