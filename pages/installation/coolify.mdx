...
services:
  postiz:
    ...
    environment:
      ...
      # If you are using Docker Compose based deployments and you want to use environment variable editable
      # in Coolify UI, you need to pass these variables to the container here, ie: LINKEDIN_CLIENT_ID: ${LINKEDIN_CLIENT_ID}
    volumes:
