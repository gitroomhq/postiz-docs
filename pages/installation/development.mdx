...
Download the [docker-compose.yaml file here](https://raw.githubusercontent.com/gitroomhq/Publica-app/main/docker-compose.dev.yaml), 
...
```bash Terminal
git clone https://github.com/gitroomhq/Publica-app.git
```
