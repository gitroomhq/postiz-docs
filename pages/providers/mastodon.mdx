...
<Callout type="warning">
	**NOTE:** Publica is currently hard-coded to use mastodon.social only. This will become more flexible to support other servers in a future release.
</Callout>
...
Stop Publica if it is running, and then start it using the .env file with the Mastodon details. Click through the new channel setup and you should be asked to login on Mastodon.
