...
3. Click Menu
  -  click "Create a new bot"
   - Enter a name for your bot (e.g., `MyPublicaBot`).

![Name Bot](https://github.com/user-attachments/assets/974c1ad3-4648-4d41-8d20-22b6e8cb0bc8)
   - Choose a unique username ending with "bot" (e.g., `MyPublicaBot_bot`).
...
```env
TELEGRAM_BOT_NAME="MyPublicaBot_bot"
TELEGRAM_TOKEN="MyPublicaBot token"
```
