...
For `DELETE` endpoints, treat both `404` and `500` as "already deleted" — see [Known Issues](/troubleshooting/known-issues) for the current 500 behaviour on missing IDs.
