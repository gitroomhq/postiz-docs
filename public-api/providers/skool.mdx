...
<Note>
Skool uses the Postiz Chrome Extension for authentication. Make sure the extension is installed and configured before using the API. See the [Skool provider guide](/self-host/providers/skool) for setup instructions.
</Note>
