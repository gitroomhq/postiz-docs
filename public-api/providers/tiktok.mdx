...
<Warning>
**Important:** TikTok requires media files to be publicly accessible via HTTPS. Local files or private URLs will fail. Use [Cloudflare R2](/self-host/configuration/r2) or similar storage with public access.
</Warning>
