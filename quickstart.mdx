...
[Installation options](/installation/overview).
</Note>
...
<Tabs>
  ...
  <Tab title="Self-hosted">
    Follow [Installation options](/installation/overview), then open your
...
<Steps>
  ...
  <Step title="Pick a platform">
    ...
    [Connect a channel](/guide/channels/connect) for what each one means.
    ...
    <Tabs>
      ...
      <Tab title="Self-hosted">
        ...
        keys in your environment, see [Provider API keys](/providers/overview).
...
2. **Write once in the Global tab.** The same text goes to every selected
   ...
   see [Global vs per-channel content](/guide/composer/global-vs-per-channel).
...
[Validation errors](/guide/composer/links-and-validation).
...
broke, see [Posting rules by platform](/guide/platforms/overview).

## Where to next

<CardGroup cols={2}>
  <Card title="How Postiz works" icon="book-open" href="/guide/concepts">
    Channels, customers, sets, tags and time slots, defined once.
  </Card>
  <Card title="Finding your way around" icon="compass" href="/guide/where-things-live">
  ...
  <Card title="Automate it" icon="robot" href="/guide/automations/auto-post-rss">
