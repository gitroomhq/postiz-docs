...
If you scale beyond one backend replica, you need a shared volume, or else
...
providers will fail and you should use [Cloudflare R2](/self-host/configuration/r2)
or a CDN instead.

## Cloudflare R2

Set `STORAGE_PROVIDER=cloudflare` and configure the R2 credentials. See
the dedicated [R2 setup guide](/self-host/configuration/r2) for the OAuth and
...
limits are documented in [troubleshooting/uploads](/general/troubleshooting/uploads).
