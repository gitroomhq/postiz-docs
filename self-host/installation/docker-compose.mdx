...
There is a [configuration reference](/self-host/configuration/reference) page with a list
...
Look through the logs for startup errors, and if you have problems, check out the [support](/general/support) page.
