---
title: Skool
description: 'How to add Skool to Postiz'
icon: 'graduation-cap'
---
...
1. The **Postiz Chrome Extension** installed. See the [Chrome Extension guide](/self-host/configuration/chrome-extension) for setup instructions.
...
- **"Extension not found"**: Make sure the Postiz Chrome Extension is installed and that `EXTENSION_ID` is correctly set. See the [Chrome Extension guide](/self-host/configuration/chrome-extension).
